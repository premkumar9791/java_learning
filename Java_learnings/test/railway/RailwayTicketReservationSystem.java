...
public class RailwayTicketReservationSystem {
    ...
    private ArrayList<Passenger2> bookedTickets = new ArrayList<>();
    private ArrayList<Passenger2> racTickets = new ArrayList<>();
    private ArrayList<Passenger2> waitingListTickets = new ArrayList<>();
    ...
    public void bookTicket() {
        ...
        if (age >5)
        {
        	Passenger2 passenger = new Passenger2(name, age, gender, berthPreference);
    ...
    private void suggestAvailableBerths(String name, int age, String gender) {
        ...
        switch (choice) {
            case 1:
                lowerBerths--;
                bookedTickets.add(new Passenger2(name, age, gender, "lower"));
                totalBerths--;
                System.out.println("Ticket booked successfully!");
                System.out.println("---------------------------------");
                break;
            case 2:
                middleBerths--;
                bookedTickets.add(new Passenger2(name, age, gender, "middle"));
                totalBerths--;
                System.out.println("Ticket booked successfully!");
                System.out.println("---------------------------------");
                break;
            case 3:
                upperBerths--;
                bookedTickets.add(new Passenger2(name, age, gender, "upper"));
                totalBerths--;
                System.out.println("Ticket booked successfully!");
                System.out.println("---------------------------------");
                break;
            ...
            case 4:
            	if (totalRACBerths > 0) {
                     racTickets.add(new Passenger2(name, age, gender, "side lower"));
                     totalRACBerths--;
                     System.out.println("Ticket booked successfully! (RAC)");
                     System.out.println("---------------------------------");
                     break;
            	}else
            	{
            		...
            		if(reply.equals("yes"))
            		{
            			 waitingListTickets.add(new Passenger2(name, age, gender, "NA"));
                         totalWaitingListTickets--;
                         System.out.println("Ticket booked successfully! (Waiting List)");
                         System.out.println("------------------------------------------");
            		}
	...
	public void cancelTicket() {
		        ...
		        Passenger2 canceledTicket = null;
		        for (Passenger2 ticket : bookedTickets) {
		        ...
		        if (!racTickets.isEmpty()) {
		            Passenger2 confirmedTicket = racTickets.remove(0);
		            totalRACBerths++;
		            bookedTickets.add(new Passenger2(confirmedTicket.name, confirmedTicket.age, confirmedTicket.gender, canceledTicket.berthPreference));
		     ...
		     // Check and move a passenger from waiting list to RAC
		        if (!waitingListTickets.isEmpty()) {
		            Passenger2 racCandidate = waitingListTickets.remove(0);
		            racTickets.add(new Passenger2(racCandidate.name, racCandidate.age, racCandidate.gender,"side lower"));
    ...
    public void printBookedTickets() {
        if (bookedTickets.isEmpty()) {
            ...
            for (int i = 0; i < bookedTickets.size(); i++) {
                Passenger2 ticket = bookedTickets.get(i);
            ...
            for (int i = 0; i < racTickets.size(); i++) {
                Passenger2 ticket = racTickets.get(i);
                System.out.println((i + 1) + ". Name: " + ticket.name + "\n   Age: " + ticket.age +
                        "\n   Gender: " + ticket.gender + "\n   Berth Preference: " + ticket.berthPreference);
            }
            System.out.println("----------------------");
            ...
            for (int i = 0; i < waitingListTickets.size(); i++) {
                Passenger2 ticket = waitingListTickets.get(i);
                System.out.println((i + 1) + ". Name: " + ticket.name + "\n   Age: " + ticket.age +
                        "\n   Gender: " + ticket.gender + "\n   Berth Preference: " + ticket.berthPreference);
            }
            System.out.println("----------------------");
